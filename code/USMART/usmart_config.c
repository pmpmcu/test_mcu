...
//	(void*)test_fun,"void test_fun(void(*ledset)(u8),u8 sta)",				  	    
	...
	(void*)fputc_AA,"int fputc_AA(int ch)",
	(void*)LED_ON_OFF, "LED_ON_OFF(char Ctr)",
	(void*)DISPLAY_COLOR, "DISPLAY_COLOR(u16 color)",
	(void*)DISPLAY_image,"DISPLAY_image(void)",
	(u8*) LCD_TEST,"LCD_TEST(u16 x,u16 y,u8 value,u16 ShowColor, u16 BackColor )",
};						  
///////////////////////////////////END///////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////
//函数控制管理器初始化
