...
#define  SPI_LCD_PORT
//-----------------LCD端口定义---------------- 
#define	LCD_LED PAout(12) //LCD背光  PB0 	    




//-----------------OLED端口定义----------------  					   
#define LCD_CS  PBout(15)
#define LCD_RST PBout(14)	//在MINISTM32上直接接到了STM32的复位脚！	
#define LCD_A0  PBout(13)
#define LCD_SCL PAout(5)		  
#define LCD_SDA PAout(7)
//#define LCD_SDA PAout(15)
...
void LCD_ShowChar(u16 x,u16 y,u8 num,u8 size,u8 mode,u16 ShowColor, u16 BackColor);						//显示一个字符
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size,u16 ShowColor, u16 BackColor);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode,u16 ShowColor, u16 BackColor);				//显示 数字
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p,u16 ShowColor, u16 BackColor);		//显示一个字符串,12/16字体
...
u8 LCD_TEST(u16 x,u16 y,u8 value,u16 ShowColor, u16 BackColor );
