...
{ 
	...
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3|GPIO_Pin_4
								|GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10;//KEY0-KEY2
...
{	 
		...
		||KEY8==0||KEY9==0||KEY10==0||KEY11==1))
	{
		...
		//else if(WK_UP==1)return WKUP_PRES;
				...
				&&KEY7==1&&KEY8==1&&KEY9==1&&KEY10==1&&KEY11==0)key_up=1; 	    
 	return 0;// 无按键按下
}
